...
L2DTestLayer::L2DTestLayer() : Layer("3D Tests") {
...
L2DTestLayer::~L2DTestLayer() {

}

void L2DTestLayer::OnAttach() {
	Registry::SetTexturePathPrefix("assets/textures/");

	SUB_EVENT(EventMouseScroll, L2DTestLayer::OnScroll);
	m_MousePosition = Mouse::GetPosition();
}

void L2DTestLayer::OnUpdate(float ts) {
...
bool L2DTestLayer::OnScroll(EventMouseScroll& e) {
